export const ar = {
  ...
  noSeller: 'لا يقدم أي مطعم توصيل في منطقتك حاليًا',
  apply: 'تطبيق',
  filters: 'تصفيات',
  help: 'مساعدة',
  ...
  sellerClosed: 'المطعم مغلق في الوقت الحالي',
  backToSellers: 'العودة إلى المطاعم',
  ...
  'All Tiffin Centers': 'جميع المواد الغذائية',
  'All Seller': 'جميع المطاعم',
  'From your previous orders': 'من طلباتك السابقة',
  'Top picked sellers for you': 'أفضل المطاعم المختارة لك',
  'Top brands in your area': 'أفضل العلامات التجارية في منطقتك',
  'Most ordered tiffin centers': 'أكثر المتاجر التي تباع فيها المواد الغذائية',
  'Most ordered sellers': 'أكثر المطاعم التي يتم طلبها',
  Discovery: 'اكتشاف',
  Store: 'متجر',
  loginRequired: 'مطلوب تسجيل الدخول',
  'Seller Closed at the moment': 'المطعم مغلق في الوقت الحالي',
  'See Menu': 'عرض القائمة',
  'Go back to sellers': 'العودة إلى المطاعم',
  PaymentNotSuccessfull: 'الدفع غير ناجح',
  Open: 'مفتوح',
  Delivery: 'التوصيل',
  Pickup: 'الاستلام',
  AddMessageforSeller: 'أضف رسالة للمطعم',
  ...
  'This seller doesn’t deliver to your location. Please explore sellers available in your delivery area': 'المطعم لا يقدم خدمة التوصيل إلى العنوان الذي اخترته حاليًا. يرجى استكشاف المطاعم المتوفرة في منطقة التوصيل الخاصة بك',
