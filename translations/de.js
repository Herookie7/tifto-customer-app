export const de = {
  ...
  Favourite: 'Favoriten',
  titleFavourite: 'Lieblingssellers',
  ...
  PENDINGStatusMessage: 'Warten auf die Akzeptanz des Sellers',
  ...
  PenddingText1: 'Der Fahrer des Sellers wird in Ihrer Nähe sein.',
  ...
  tiftoUseYourLocationMessage:
    'Yalla verwendet Ihren Standort, um die Sellers in Ihrer Nähe anzuzeigen!',
  ...
  search: 'Suche',
  searchSeller: 'Nach Sellers suchen',
  ...
  dontHaveAnyOrderYet:
    'Sie haben noch keine vergangenen Bestellungen. Probieren Sie eines unserer tollen Sellers aus und geben Sie Ihre erste Bestellung auf!',
  ...
  noSellers: 'Keine Sellers',
  clearCartText:
    'Beim Verlassen dieser Sellerseite werden die Artikel, die Sie zum Warenkorb hinzugefügt haben, gelöscht',
  okText: 'OK',
  edit: 'Bearb',
  change: 'Ändern',
  ...
  noSeller: 'Kein Seller bietet derzeit Lieferung in Ihrer Region an',
  apply: 'Anwenden',
  filters: 'Filter',
  help: 'Hilfe',
  ...
  faq2Description:
    'Die Lieferkosten variieren je nach Ihrem Standort und dem Seller, von dem Sie bestellen. Sie können die Lieferkosten für Ihre Bestellung anzeigen, bevor Sie sie im Checkout-Prozess abschließen.',
  ...
  faq4Description:
    'Die Lieferzeiten können je nach Faktoren wie der Vorbereitungszeit des Sellers, den Verkehrsbedingungen und Ihrem Standort variieren. Wir bemühen uns jedoch, Ihre Bestellung innerhalb eines angemessenen Zeitrahmens zu liefern, der normalerweise zwischen 30 und 60 Minuten liegt.',
  faq5: 'Kann ich meine Bestellung stornieren, nachdem sie aufgegeben wurde?',
  faq5Description:
    'Ja, Sie können Ihre Bestellung stornieren, sobald sie aufgegeben wurde. Sobald die Bestellung jedoch vorbereitet und zur Lieferung verschickt wurde, können Sie die Bestellung nicht mehr stornieren. Sie können sich direkt an das Seller wenden, um Unterstützung zu erhalten.',
  faq6: 'Wie kann ich Feedback zu meiner Erfahrung geben?',
  faq6Description:
    'Sie können Feedback über die App geben, indem Sie Ihre Bestellung bewerten und Kommentare hinterlassen. Sie können auch das Seller bewerten und eine Rezension hinterlassen.',
  faq7: 'Kann ich gleichzeitig von mehreren Orten bestellen?',
  faq7Description:
    'Leider können Sie nicht aus mehreren Sellers innerhalb derselben Bestellung wählen. Sie können jedoch gleichzeitig separate Bestellungen von verschiedenen',
  away: 'weg',
  placeOrder: 'Bestellung aufgeben',
  titleFAQ: 'Häufig gestellte Fragen',
  continueAsGuest: 'Als Gast fortfahren',
  sellerClosed: 'Seller derzeit geschlossen',
  backToSellers: 'Zurück zu den Sellers',
  ...
  restrictionsInstructions:
    'Wenn Sie Allergien oder andere diätetische Einschränkungen haben, kontaktieren Sie bitte das Seller. Das Seller stellt auf Anfrage spezifische Informationen zum Essen bereit.',
  preservationText:
  ...
  brandName: 'Tifto',
  welcomeText: 'Willkommen bei Tifto',
  createAccountDesc:
    'Genießen Sie die besten Sellers oder erhalten Sie, was Sie von nahegelegenen Geschäften benötigen, geliefert!',
  ...
  'All Tiffin Centers': 'Alle Lebensmittel',
  'All Seller': 'Alle Sellers',
  'From your previous orders': 'Aus Ihren vorherigen Bestellungen',
  'Top picked sellers for you': 'Top-ausgewählte Sellers für Sie',
  'Top brands in your area': 'Top-Marken in Ihrer Region',
  'Most ordered tiffin centers': 'Am meisten bestellte Lebensmittelgeschäfte',
  'Most ordered sellers': 'Am meisten bestellte Sellers',
  Discovery: 'Entdeckung',
  Store: 'Geschäft',
  loginRequired: 'Anmeldung erforderlich',
  sellerClosedMessage: 'Seller momentan geschlossen',
  seeMenu: 'Speisekarte ansehen',
  goBackToSellers: 'Zurück zu den Sellers',
  PaymentNotSuccessfull: 'Zahlung nicht erfolgreich',
  'Seller Closed at the moment': 'Seller momentan geschlossen',
  'See Menu': 'Speisekarte ansehen',
  'Go back to sellers': 'Zurück zu den Sellers',
  Open: 'Offen',
  Delivery: 'Lieferung',
  Pickup: 'Abholung',
  AddMessageforSeller: 'Nachricht für das Seller hinzufügen',
  ...
  Card: 'Karte',
  OrderPriceValidation: 'Ihr Bestellbetrag liegt unter dem Mindestbestellwert des Sellers. Bitte fügen Sie weitere Artikel zu Ihrem Warenkorb hinzu.',
  ...
  'This seller doesn’t deliver to your location. Please explore sellers available in your delivery area': 'Das Seller liefert derzeit nicht an die ausgewählte Adresse. Bitte sehen Sie sich die in Ihrem Liefergebiet verfügbaren Sellers an',
