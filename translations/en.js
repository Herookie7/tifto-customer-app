export const en = {
  ...
  welcomeScreen: 'Welcome to Tifto',
  loginBtn: 'Login',
  ...
  titleFavourite: 'Favourite Sellers',
  ...
  PENDINGStatusMessage: 'Waiting for seller to accept',
  ...
  PenddingText1: 'The seller rider will be at your place around.',
  ...
  tiftoUseYourLocationMessage:
    'To find sellers near you, we just need your location',
  ...
  search: 'Search',
  searchSeller: 'Search for sellers',
  ...
  dontHaveAnyOrderYet:
    "You don't have any past order yet. Try one of our awesome sellers and place your first order!",
  ...
  clearCartText:
    'By leaving this seller page, the items you`ve added to cart will be cleared',
  okText: 'OK',
  yourOrder: 'Order',
  ...
  noSeller: 'No seller currently offers delivery in your area',
  apply: 'Apply',
  filters: 'Filters',
  help: 'Help',
  ...
  faq2Description:
    "Delivery charges vary depending on your location and the seller you're ordering from. You can view the delivery charges applicable to your order before finalizing it during the checkout process.",
  ...
  faq4Description:
    "Delivery times may vary depending on factors such as the seller's preparation time, traffic conditions, and your location. However, we strive to deliver your order within a reasonable timeframe, typically ranging from 30 to 60 minutes.",
  faq5: "Can I cancel my order after it's been placed?",
  faq5Description:
    'Yes you can cancel your order once it is placed. However, once the order has been prepared and sent out for delivery, you can no longer cancel the order. You may contact the seller directly for assistance.',
  faq6: 'How can I provide feedback on my experience?',
  faq6Description:
    'You can provide feedback through the app by rating your order and leaving comments. You can also give a rating to the seller and leave a review.',
  faq7: 'Can I order from multiple places at the same time?',
  faq7Description:
    'Unfortunately, you can’t choose from multiple sellers within the same order. However, you can place separate orders from different sellers at the same time.',
  away: 'away',
  placeOrder: 'Place Order',
  continueAsGuest: 'Continue as Guest',
  sellerClosed: 'Seller Closed at the moment',
  backToSellers: 'Go back to sellers',
  seeMenu: 'See Menu',
  ...
  allGrocery: 'All Tiffin Centers Shops',
  ...
  restrictionsInstructions: 'If you have allergies or other dietary restrictions, please contact the seller. The seller will provide food-specific information upon request.',
  ...
  brandName: 'Tifto',
  welcomeText: 'Welcome to Tifto',
  createAccountDesc:
    'Enjoy the best sellers or get what you need from nearby Tiffin Centers, delivered',
  ...
  'Tiffin Centers List': 'Tiffin Centers List',
  'Grocery List': 'Grocery List',
  'Top grocery picks': 'Top grocery picks',
  'No grocery categories available': 'No grocery categories available',
  'No restaurant categories available': 'No restaurant categories available',
  'No brands available': 'No brands available',
  'No restaurant brands available': 'No restaurant brands available',
  'No grocery brands available': 'No grocery brands available',
  'Top Grocery Brands': 'Top Grocery Brands',
  'Top Seller Brands': 'Top Seller Brands',
  ...
  'All Tiffin Centers': 'All Tiffin Centers',
  'All Seller': 'All Seller',
  'From your previous orders': 'From your previous orders',
  'Top picked sellers for you': 'Top picked sellers for you',
  'Top brands in your area': 'Top brands in your area',
  'Most ordered tiffin centers': 'Most ordered tiffin centers',
  'Most ordered sellers': 'Most ordered sellers',
  Discovery: 'Discovery',
  Store: 'Store',
  loginRequired: 'Login Required',
  'Seller Closed at the moment': 'Seller Closed at the moment',
  'See Menu': 'See Menu',
  'Go back to sellers': 'Go back to sellers',
  PaymentNotSuccessfull: 'Payment Not Successfull',
  Open: 'Open',
  Delivery: 'Delivery',
  Pickup: 'Pickup',
  AddMessageforSeller: 'Add a message for the seller',
  ...
  exploreYallaCities: 'Explore Tifto Cities',
  Card: 'Card',
  ...
  OrderPriceValidation: "Your order amount is below the seller's minimum order requirement. Please add more items to your cart.",
  "Can't deliver to this address": "Can't deliver to this address",
  'This seller doesn’t deliver to your location. Please explore sellers available in your delivery area': 'This seller doesn’t deliver to your location. Please explore sellers available in your delivery area',
