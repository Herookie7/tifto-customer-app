export const fr = {
  ...
  Favourite: 'Favoris',
  titleFavourite: 'sellers préférés',
  ...
  PENDINGStatusMessage: "En attente de l'acceptation du seller",
  ...
  PenddingText1: 'Le livreur du seller sera chez vous vers.',
  ...
  tiftoUseYourLocationMessage:
    'Yalla utilise votre emplacement pour afficher les sellers à proximité de chez vous !',
  ...
  search: 'Rechercher',
  searchSeller: 'Rechercher des sellers',
  ...
  dontHaveAnyOrderYet:
    "Vous n'avez encore aucune commande passée. Essayez l'un de nos sellers formidables et passez votre première commande !",
  ...
  noSellers: 'Pas de sellers',
  clearCartText:
    'En quittant cette page du seller, les articles que vous avez ajoutés au panier seront effacés',
  okText: 'OK',
  edit: 'modifier',
  change: 'Changement',
  ...
  noSeller:
    'Aucun seller ne propose actuellement de livraison dans votre région',
  apply: 'Appliquer',
  filters: 'Filtres',
  help: 'Aide',
  ...
  faq2Description:
    'Les frais de livraison varient en fonction de votre emplacement et du seller auprès duquel vous commandez. Vous pouvez consulter les frais de livraison applicables à votre commande avant de la finaliser lors du processus de paiement.',
  ...
  faq4Description:
    'Les délais de livraison peuvent varier en fonction de facteurs tels que le temps de préparation du seller, les conditions de circulation et votre emplacement. Cependant, nous nous efforçons de livrer votre commande dans un délai raisonnable, généralement compris entre 30 et 60 minutes.',
  faq5: "Puis-je annuler ma commande une fois qu'elle est passée?",
  faq5Description:
    "Oui, vous pouvez annuler votre commande une fois qu'elle est passée. Cependant, une fois que la commande a été préparée et envoyée pour la livraison, vous ne pouvez plus l'annuler. Vous pouvez contacter directement le seller pour obtenir de l'aide.",
  faq6: 'Comment puis-je donner mon avis sur mon expérience?',
  faq6Description:
    "Vous pouvez donner votre avis via l'application en notant votre commande et en laissant des commentaires. Vous pouvez également donner une note au seller et laisser un avis.",
  faq7: 'Puis-je commander à plusieurs endroits en même temps?',
  faq7Description:
    'Malheureusement, vous ne pouvez pas choisir parmi plusieurs sellers dans la même commande. Cependant, vous pouvez passer des commandes séparées auprès de différents sellers en même temps.',
  away: 'loin',
  placeOrder: 'Passer commande',
  titleFAQ: 'Questions fréquemment posées',
  continueAsGuest: "Continuer en tant qu'invité",
  sellerClosed: 'Seller fermé pour le moment',
  backToSellers: 'Retour aux sellers',
  ...
  restrictionsInstructions:
    "Si vous avez des allergies ou d'autres restrictions alimentaires, veuillez contacter le seller. Le seller fournira des informations spécifiques sur les aliments sur demande.",
  preservationText:
  ...
  brandName: 'Tifto',
  welcomeText: 'Bienvenue chez Tifto',
  createAccountDesc:
    'Profitez des meilleurs sellers ou obtenez ce dont vous avez besoin dans les magasins à proximité, livré!',
  ...
  'All Tiffin Centers': "Tous les produits d'épicerie",
  'All Seller': 'Tous les sellers',
  'From your previous orders': 'De vos commandes précédentes',
  'Top picked sellers for you': 'Les meilleurs sellers sélectionnés pour vous',
  'Top brands in your area': 'Meilleures marques dans votre région',
  'Most ordered tiffin centers': "Magasins d'épicerie les plus commandés",
  'Most ordered sellers': 'Sellers les plus commandés',
  Discovery: 'Découverte',
  Store: 'Magasin',
  loginRequired: 'Connexion requise',
  sellerClosedMessage: 'Seller fermé pour le moment',
  seeMenu: 'Voir le menu',
  goBackToSellers: 'Retourner aux sellers',
  PaymentNotSuccessfull: 'Paiement non réussi',
  'Seller Closed at the moment': 'Seller fermé pour le moment',
  'See Menu': 'Voir le menu',
  'Go back to sellers': 'Retourner aux sellers',
  Open: 'Ouvert',
  Delivery: 'Livraison',
  Pickup: 'Retrait',
  AddMessageforSeller: 'Ajouter un message pour le seller',
  ...
  Card: 'Carte',
  OrderPriceValidation: "Le montant de votre commande est inférieur au montant minimum requis par le seller. Veuillez ajouter d'autres articles à votre panier.",
  ...
  'This seller doesn’t deliver to your location. Please explore sellers available in your delivery area': "Le seller ne livre pas actuellement à l'adresse sélectionnée. Veuillez explorer les sellers disponibles dans votre zone de livraison",
